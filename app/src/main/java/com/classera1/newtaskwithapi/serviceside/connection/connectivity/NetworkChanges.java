...
public class NetworkChanges extends BroadcastReceiver {
...
//                            Toast.makeText(context, "Internet availablle via Broadcast receiver", Toast.LENGTH_SHORT).show();
                            ...
                            // go to next activity
                            Toast.makeText(context, "Network Availbe", Toast.LENGTH_LONG).show();
                        } else {
                            Toast.makeText(context, "Network NOT Availbe", Toast.LENGTH_LONG).show();
                            return false;
                        }
                    }
                }
